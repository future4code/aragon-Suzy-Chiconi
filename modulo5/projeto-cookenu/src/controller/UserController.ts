    ...
    public signup = async (req: Request, res: Response) => {
        ...
        try {
            ...
            if (!email.includes("@") || !email.includes(".com")) {
                throw new Error("O parâmetro 'email' deve possuir um formato válido")
            }
    ...
    public deleteUser = async (req: Request, res: Response) => {
        ...
        try {
            ...
            if (payload.role !== USER_ROLES.ADMIN) {
                errorCode = 403
                throw new Error("Acesso negado! Usuário sem autorização para esse recurso!")
            }
            ...
            if (id === payload.id) {
                throw new Error("Não é possível deletar sua própria conta! Solicite a exclusão a um ADMIN.")
            }
